...
# ACDS 15.0 153 win32 2017.01.24.16:07:25
# ----------------------------------------
...
# # End of template
# ----------------------------------------
# If PLL30MhzV1 is one of several IP cores in your
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/PLL30MhzV1.vho"
}
